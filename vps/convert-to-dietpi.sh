...
PROFILE_URL=https://raw.githubusercontent.com/mews-se/dietpi-factory/main/config
...
INSTALLER_URL=https://raw.githubusercontent.com/MichaIng/DietPi/$DIETPI_REF/.build/images/dietpi-installer
...
apt-get -o DPkg::Lock::Timeout=600 update
curl -fsSL "$INSTALLER_URL" -o "$TMPD/dietpi-installer"
